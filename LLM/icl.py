...
from icl_util import ExampleSelectStrategy,select_examples
    ...
    for prompt_id, prompt_template in enumerate(prompt_templates):
        ...
        for batch_id in tqdm(range(0, len(test_set), batch_size)):
            ...
            for test_set_item in batch:
                examples, examples_lens = select_examples(test_set_item['id'], example_select_strategy, tokenizer.encode)
